    ...
    <div id="wrapper">
        <div id="header" data-intro='Chào mừng đến với KPI 28. Sau đây tôi sẽ hướng dẫn bạn sử dụng KPI 28 hiệu quả.'
            ...
            <div id="header-content">
                ...
                <div id="hc-right">
                    <form action="" class="search" data-intro='Tìm kiếm bất cứ điều gì ở KPI HTPH tại đây.'
                        data-step ="2">
                    ...
                    <div id="dark-mode" data-intro='Điều chỉnh luân phiên chế độ Sáng Tối.' data-step ="4"
                        class="header-item"><span><i class="fa-regular fa-lightbulb"></i></span></div>
                    <div id="notice" data-intro='Xem các thông báo gửi từ hệ thống tại đây nhé!' data-step ="5"
                        class="header-item"><span><i class="fa-regular fa-bell"></i></span></div>
