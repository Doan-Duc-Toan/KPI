...
@section('content')
    ...
    <link rel="stylesheet" href="{{ asset('css/setting_res.css') }}">
        ...
        <form action="">
            <div id="setting-profile">
                <div id="setting-status"
                    data-intro='Chúng tôi chia phần cài đặt thành 3 trạng thái. Luân chuyển các trạng thái bằng cách click vào chúng.'
                    data-step ="13">
                ...
                <div id="setting-info"
                    data-intro='Chi tiết nội dung cài đặt hiển thị tại đây. Hãy điều chỉnh chúng phù hợp theo mong muốn của bạn.'
                    data-step ="14">
                    @include('profile_user')
                </div>
            </div>
            <div id="setting-save">
                <button data-intro='Sau khi đã điều chỉnh những thông tin cần thiết, hãy bấm "Lưu".'
                    data-step ="15">Lưu</button>
            </div>
        </form>
